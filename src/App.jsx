    ...
    <div className="container my-2">
      ...
      <div className="row justify-content-center">
        <div className="col-md-4">
          <div className="card pt-3 shadow mb-3">         
            <div className="card-body text-primary">
              <input type="text" className="form-control form-control-lg 
              mb-4 text-center bg-light text-primary shadow" value={val} onChange={(e) =>setVal(e.target.value)} />
              <div className="row mt-2">
                <div className="col-3">
                   <button className="btn btn-light w-75 text-primary shadow  py-4 fs-4"
              ...
              <div className="row mt-2">
               ...
               <div className="col-3">
                 <button className="btn btn-light w-75 text-primary shadow px-2 py-4 fs-4"
